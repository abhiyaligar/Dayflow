          ...
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-[#E2E6F2] text-[#171A45]">
              ...
              {filteredLeaves.length === 0 && (
                <tr>
                  <td colSpan={isAdminOrHR ? 7 : 6} className="p-8 text-center text-xs font-bold text-[#70738D]">
            ...
            <div>
              ...
              <div className="space-y-4">
                {visualEarlyRisers.length === 0 ? (
                  <p className="text-xs text-center text-[#9A9DB5] py-8 font-semibold">No early risers logged today.</p>
                ) : (
            ...
            <div>
              ...
              <div className="space-y-4">
                {visualLateArrivals.length === 0 ? (
                  <p className="text-xs text-center text-[#9A9DB5] py-8 font-semibold">No late arrivals logged today.</p>
                ) : (
            ...
            <div>
              ...
              <div className="space-y-4">
                {visualMissingPunch.length === 0 ? (
                  <p className="text-xs text-center text-[#9A9DB5] py-8 font-semibold">No missing punches logged today.</p>
                ) : (
